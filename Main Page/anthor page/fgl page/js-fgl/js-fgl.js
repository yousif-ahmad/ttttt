...
function countDownTime() {
  ...
  let downSecond = setInterval(function () {
    ...
    --light;
    let minLight = (light * 100) / 3000;
    circleLight.style.backgroundImage = `linear-gradient(to right, #9b2062 ${minLight}%, #1e2229 0%)`;
    ...
    if (
      ...
      circleLight.style.backgroundImage = `linear-gradient(to right, #9b2062 ${0}%, #1e2229 0%)`;
